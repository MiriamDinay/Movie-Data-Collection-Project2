...
## תיאור הפרויקט
פרויקט זה בונה מודל למידת מכונה החוזה את הדירוג הממוצע של סרטים (averageRating) טרם יציאתם לאקרנים, בהתבסס על נתוני IMDb וויקיפדיה. המודל שנבחר והציג את הביצועים הטובים ביותר הוא **Random Forest**.
